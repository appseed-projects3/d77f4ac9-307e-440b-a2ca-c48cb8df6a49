...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-11 08:01`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d77f4ac9-307e-440b-a2ca-c48cb8df6a49.git
$ cd d77f4ac9-307e-440b-a2ca-c48cb8df6a49
```
